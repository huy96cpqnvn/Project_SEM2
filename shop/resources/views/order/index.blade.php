                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td>id</td>
                                        <td><img src="" alt="dell" width="80" height="50"></td>
                                        <td>name</td>
                                        <td class="text-center">
                                            ...
                                            <a href="#"><span class="glyphicon glyphicon-minus"></span></a>
                                            {{--                                                @endif--}}
                                            <input type="text" class="qty text-center" value="3" style="width:30px; font-weight:bold; font-size:15px; color:blue;" readonly="readonly">
                                            <a href=""><span class="glyphicon glyphicon-plus-sign"></span></a>
                                        </td>
                                        <td><a href="" onclick="return xacnhan('Xóa sản phẩm này ?')" ><span class="glyphicon glyphicon-remove" style="padding:5px; font-size:18px; color:#ff0000;"></span></a></td>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                        <div class="thumbnail mobile">
                            ...
                            <div class="ct">
                                ...
                                <li><strong>CPU</strong> : <i>cpu</i></li>
                                <li><strong>Màn Hình</strong> : <i>man hinh</i></li>
                                <li><strong>Camera</strong> : Trước  <i>camera</i> Sau <i>$row->cam2</i></li>
                                <li><strong>HĐH</strong> :<i> hdh </i> <strong> Bộ nhớ trong</strong> :<i> bnt </i></li>
                                <li><strong>Pin</strong> :<i> pin</i></li>
                                </a>
                            </div>
                            <span class="btn label-warning"><strong>number_format($row->price)!!}</strong>Vnd </span>
                            <a href="#" class="btn btn-success pull-right add">Thêm vào giỏ </a>
                        </div> <!-- / div thumbnail -->
                    </div>  <!-- /div col-4 -->
                    {{--                    @endforeach--}}
